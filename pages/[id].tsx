...
const Details = (initialData) => {
  ...
  // const { data: allCoins2, } = useSWR("/coins/markets?vs_currency=usd&ids=bitcoin%2C%20ethereum%2C%20ripple&order=market_cap_desc&per_page=100&page=1&sparkline=false", {
      ...
      <div>
        ...
        >
          ...
          <div>
            ...
            {/* <h1>{timeConverter(coin2.prices[0][0]) + ' ' + coin2.prices[0][1]}</h1> */}
